...
var createNewCorpus = function(dbConnection, callback) {
  ...
  server.db.create(dbConnection.couchConnection.pouchname, function(err, body) {
    ...
    // TODO why are you returning only the pouchname? what if the calling app wants to open the corpus for the user? You should probably return the entire couchConnection, or then entire corpus doc.
