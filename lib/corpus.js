...
var isRequestingUserAnAdminOnCorpus = function(req, requestingUser, dbConn, done) {
  ...
  console.log("TEST!!!!!!!!!!!!!!!!!!!");
  console.log(dbConn);
  console.log(couch_keys.username);
  console.log(couch_keys.password);
  var usersdb = require('nano')(dbConn.protocol + couch_keys.username + ':' + couch_keys.password + '@' + dbConn.domain + ':' + dbConn.port + dbConn.path + "/_users");
