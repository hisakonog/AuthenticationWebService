  ...
  usersdb.save(userid, userParamsForNewUser, function(err, doc) {
    ...
    if (err != null || !doc.ok) {
      ...
      createDBforUsersActivities(
        ...
        function(res) {
          console
            .log(new Date() + " There was success in creating the users activity feed: " + res);
          ...
          createDBforCorpus(
            ...
            function(res) {
              console
                .log(new Date() + " There was success in creating the users first corpus: " + res);
            ...
            function(err) {
              console
                .log(new Date() + " There was an error in creating users first corpus: " + err);
              if (typeof errorcallback == "function") {
                errorcallback();
              }
            });
